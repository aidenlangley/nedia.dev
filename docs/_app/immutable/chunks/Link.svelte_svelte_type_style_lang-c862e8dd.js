import{r as e}from"./index-7c64d610.js";const o=[{page:"home",url:"/"},{page:"r\xE9sum\xE9",url:"/resume"},{page:"blog"}];e("Aiden");e("Langley");const n=e("aiden@nedia.dev"),i=e("+642040773742"),a=e(`Born in Aotearoa and grew up in London, England.
  World of Warcraft nerd turned Software Engineer and Linux enthusiast.`);e(["cooking & baking","games","football","technology","art & design"]);const s=e([{title:"bspcq",description:[`A hobby of mine is tinkering with Linux - this was
        ...
        lot of fun to write.`],urls:["https://github.com/aidenlangley/bspcq","https://pypi.org/project/bspcq"],key_words:["Python","A toy/tool for bspwm, a window manager for Linux"]},{title:"nedots",description:[`Another hobby related to the first is writing what you might call
        ...
        the product.`],urls:["https://github.com/pop-os/launcher"],key_words:["Pop_OS!","Rust","System76"]},{title:"Whakaoranga Whanau",description:[`During a rough patch in my life I ended up in the care of
        ...
        would help out on the forums, moderating for a time.`],urls:["https://github.com/Tukui-org/Tukui","https://www.tukui.org"],key_words:["Gaming","User interface","Lua"]}]),r=e("https://github.com/aidenlangley/nedia.dev"),l=e("https://svelte.dev/"),h=e("https://kit.svelte.dev/");e(new Date(1993,10));e([{institute:"Woodbridge High School",grade:"11 GCSE's, 2 A Levels"},{institute:"City & Guilds",grade:"Diploma in IT & Systems Engineering"}]);const c=e([{company:"Bottomline Technologies",industry:"Financial Technology",location:"St Paul's, London",duration:"2.5 years",titles:["Technical Analyst"],technologies:["Java","OracleDB","C#/.Net"],responsibilities:["Design bespoke payment solutions for banks & other corporates.",`Work with the client onsite or otherwise on implementing their
      solution.`,"Implementing & ensuring compliance with SWIFT & SEPA standards."],notables:["Tesco's","Deutche Bank","Lloyds TSB","HSBC","Barclays","Scottish Widows","HSBC","J.P. Morgan"]},{company:"ezyVet",industry:"Veterinary",location:"Auckland, New Zealand",duration:"Closing on 3 years",titles:["Full Stack Engineer","Conversion Engineer","Global 2nd Line Support"],responsibilities:[`Originally in a small team of developers during the start-up era of the
        company - bug fixes & features were the primary focus.`,`Later moved into a role in the conversions team responsible for reverse
        ...
        event and we would oblige.`],notables:["On-site support","Some of the largest schools in the North","Whanagarei Girls & Boys High","Kerikeri High","Okaihau College"]},{company:"Whakaoranga Whanau Recovery Hub",industry:"Alcohol & Other Drug Rehabilitation",location:"Northland, New Zealand",duration:"1.5 years",titles:["IT Director"],technologies:["Networking","DHCP","Cloud Solutions","Google Workspace","Svelte","Netlify & NetlifyCMS"],responsibilities:[`Learning and conversing in Te Reo M\u0101ori was a large part of the role.
        ...
        infrastructure.`,"Kapahaka","Interpersonal skills"],notables:["Voluntary role with little by way of financial compensation but a fulfilling job nonetheless","Managing all IT infrastructure for a small office","Lots of teaching"]}]);export{h as a,r as b,i as c,s as d,n as e,a as f,c as g,o as p,l as s};
